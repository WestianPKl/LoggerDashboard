...
import type { IAddInventoryTypeProps } from '../scripts/inventories'

export default function AddInventoryTypeDialog({
	edit,
	selectedItems,
	openAddDialog,
	handleCloseAdd,
	addItemHandler,
}: IAddInventoryTypeProps) {
	...
	return (
		<Dialog sx={{ width: '100%' }} open={openAddDialog} onClose={closeDialog} closeAfterTransition={false}>
			<DialogTitle>{edit ? 'Edit inventory Type' : 'Add inventory Type'}</DialogTitle>
