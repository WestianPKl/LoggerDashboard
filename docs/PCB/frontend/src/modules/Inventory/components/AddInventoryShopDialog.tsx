...
import type { IAddInventoryShopProps } from '../scripts/inventories'

export default function AddInventoryShopDialog({
	edit,
	selectedItems,
	openAddDialog,
	handleCloseAdd,
	addItemHandler,
}: IAddInventoryShopProps) {
	...
	return (
		<Dialog open={openAddDialog} onClose={closeDialog} closeAfterTransition={false} maxWidth='xs' fullWidth>
			<DialogTitle sx={{ fontWeight: 600 }}>{edit ? 'Edytuj sklep' : 'Dodaj sklep'}</DialogTitle>
