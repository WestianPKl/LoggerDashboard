...
/**
 * @brief Display timestamp and environmental measurements; report errors.
 *
 * @details
 ...
 * @par Side effects
 *   I2C transactions with RTC/sensor, LCD updates, RGB LED color changes and optional network logging.
 * @return void
 */
